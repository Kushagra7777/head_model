...
# python single_full.py --input_dir work_dir/model_ready_folders/setolabo_samples_as_test/LCGB2 --result_dir work_dir/model_ready_folders/setolabo_samples_as_test/LCGB2_result_full --seed 42 --estimator all --n_samples -1 --n_features -1
